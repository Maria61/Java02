...
public class MapTest {
	...
	public void testContainsKeyOrValue() {
		...
		Scanner console = new Scanner(System.in);
		String stuId = console.next();
		System.out.println("您输入的学生ID为"+stuId);
		System.out.println("您查询的学生在学生映射表中是否存在？"+students.containsKey(stuId));
		if(students.containsKey(stuId)) {
			System.out.println("对应的学生姓名为："+students.get(stuId).name);
		}
		...
		if(students.containsValue(new Student(null,name))) {
			...
			System.out.println("在学生映射表中，不存在学生"+name);
		}
