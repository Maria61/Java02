...
public class LoginFrame extends JFrame implements ActionListener,MouseListener{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else
		{
			...
			{	
				...
				String num=numTxt.getText();
				deal.deleteStudent(num);
				String rename1=rename.getText();
				String renum2=renum.getText();
				tmp.setName(rename1);
				tmp.setNum(renum2);
				deal.addStudent(tmp);
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		if(str.equals("修改学生"))
		{
			controlPa.removeAll();
			//清空操作面板的所有控件
			numLa=new JLabel("请输入要修改的学号");
			numLa.setSize(150, 30);
			numLa.setLocation(30, 30);
			controlPa.add(numLa);
			numLa=new JLabel("请输入修改后的学号");
			numLa.setSize(150, 30);
			numLa.setLocation(30, 80);
			controlPa.add(numLa);
			nameLa=new JLabel("请输入修改后的学生姓名");
			nameLa.setSize(150, 30);
			nameLa.setLocation(30, 130);
			controlPa.add(nameLa);
			numTxt=new JTextField();
			numTxt.setSize(100, 30);
			numTxt.setLocation(180, 30);
			controlPa.add(numTxt);
			renum=new JTextField();
			renum.setSize(100, 30);
			renum.setLocation(180, 80);
			controlPa.add(	renum);
